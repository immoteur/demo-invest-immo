export const departments = [
  ...
  { code: '977', name: 'Saint-Barthelemy' },
  { code: '978', name: 'Saint-Martin' },
  { code: '984', name: 'Terres australes et antarctiques francaises' },
  { code: '986', name: 'Wallis-et-Futuna' },
  { code: '987', name: 'Polynesie francaise' },
  { code: '988', name: 'Nouvelle-Caledonie' },
] as const;
